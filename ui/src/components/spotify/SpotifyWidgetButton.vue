<template>
	...
	>
		<div
			v-if="currentTrack"
			class="flex-1 text-gray-100 flex text-left bg-gray-900 rounded px-2 py-px text-xs items-center"
		>
			<div class="flex flex-wrap flex-1">
				<span class="w-full font-bold">{{ currentTrack.name }}</span>
...
import SpotifyBoard from '@/components/spotify/SpotifyBoard.vue';
...
export default class SpotifyWidgetButton extends BaseComponent {
